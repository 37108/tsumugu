...
| ---------------- | --------------------------- |
| Minimum          | **24.0.0**                  |
| Supported line   | 24.x "Krypton" (Active LTS) |
...
to the pinned version automatically. In this repository, pnpm 10.33.0
...
- Development tooling, including TypeScript and Vitest, may be upgraded at any time,
...
| ------------------------------------------------ | ---------------------------------------------------- | ---------------------------------------------------------------------------- |
| CSS grid, custom properties, `:focus-visible`    | the shell's layout and focus styling                 | the page is unreadable below this floor; all have broad support              |
...
`docs/designs/accessibility.md` is the cross-browser check, and this table is the
